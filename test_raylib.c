...
int main(void)
{
   ...
   char widthmm[256];
   sprintf(widthmm, "Width mm: %d", GetMonitorPhysicalWidth(currentMonitor));
   TraceLog(LOG_INFO, widthmm);
   char heightmm[256];
   sprintf(heightmm, "Height mm: %d", GetMonitorPhysicalHeight(currentMonitor));
   TraceLog(LOG_INFO, heightmm);
   char height[256];
   sprintf(height, "Height: %d", GetMonitorHeight(currentMonitor));
   TraceLog(LOG_INFO, height);
   char width[256];
   sprintf(width, "Width: %d", GetMonitorWidth(currentMonitor));
   TraceLog(LOG_INFO, width);
    //--------------------------------------------------------------------------------------
